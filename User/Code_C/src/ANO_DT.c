...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(Attitude.Angle->x,Attitude.Angle->y,RTK_XYZ_HP.Heading,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser)
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(MPU6050.Data->ACC_ADC.x,MPU6050.Data->ACC_ADC.y,MPU6050.Data->ACC_ADC.z,
												MPU6050.Data->GYR_ADC.x,MPU6050.Data->GYR_ADC.y,MPU6050.Data->GYR_ADC.z,
												HMC5883.Data->MAG_Original.x,HMC5883.Data->MAG_Original.y,HMC5883.Data->MAG_Original.z,0);
	}	 
/////////////////////////////////////////////////////////////////////////////////////
...
//											ctrl_2.PID[PIDYAW].kp,ctrl_2.PID[PIDYAW].ki,ctrl_2.PID[PIDYAW].kd);
	...
	{
		f.send_location = 0;
		ANO_DT_Send_Location((int)(RTK_XYZ_HP.PX*100)%10000,(int)(RTK_XYZ_HP.PY*100)%10000,(int)(RTK_XYZ_HP.PZ*100)%10000);
	}
...
void ANO_DT_Send_Data(u8 *dataToSend , u8 length)
{
	...
	USART1_Send_Str(dataToSend,length);
#endif
}
...
//    {
//        FlyControl.Para->ATT_Outer_PID_x.Kp  = 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
//        FlyControl.Para->ATT_Outer_PID_x.Ki  = 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
//        FlyControl.Para->ATT_Outer_PID_x.Kd  = 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
//        FlyControl.Para->ATT_Outer_PID_y.Kp = 0.001*( (vs16)(*(data_buf+10)<<8)|*(data_buf+11) );
//        FlyControl.Para->ATT_Outer_PID_y.Ki = 0.001*( (vs16)(*(data_buf+12)<<8)|*(data_buf+13) );
//        FlyControl.Para->ATT_Outer_PID_y.Kd = 0.001*( (vs16)(*(data_buf+14)<<8)|*(data_buf+15) );
//        FlyControl.Para->ATT_Outer_PID_z.Kp 	= 0.001*( (vs16)(*(data_buf+16)<<8)|*(data_buf+17) );
//        FlyControl.Para->ATT_Outer_PID_z.Ki 	= 0.001*( (vs16)(*(data_buf+18)<<8)|*(data_buf+19) );
//        FlyControl.Para->ATT_Outer_PID_z.Kd 	= 0.001*( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
...
void ANO_DT_Send_Location(float Lon,float Lat,float Alt)
{
	u8 _cnt=0;
	vs16 _temp;
